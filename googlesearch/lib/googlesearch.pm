...
sub search  {
	...
	my @results;                            
	my $url = "https://www.google.com$country/search?output=search&sclient=psy-ab&q=$keyword&btnG=&gbv=1";
	if (defined $start )
	{$url.= "&start=$start";}
...
sub isIndexed  {
	...
	my @results;                            
	my $url = "https://www.google.com.uy/search?output=search&sclient=psy-ab&q=$keyword&btnG=&gbv=1";
